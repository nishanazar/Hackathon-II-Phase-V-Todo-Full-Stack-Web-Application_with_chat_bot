...
user: USER
command: sp.specify
labels: ["minikube", "helm", "kubernetes", "deployment", "specification"]
links:
  spec: null
  ticket: null
  adr: null
